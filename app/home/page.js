    ...
    <section className="flex flex-col items-center justify-center gap-[100px] h-auto">
      <div className="bg-dark w-full h-auto flex flex-col gap-[100px] py-[80px]  items-center justify-center">
        <div className="flex flex-col gap-12 relative items-center  max-w-7xl w-11/12   h-auto">
          ...
          <div className="font-medium items-center font-inter text-start md:text-center max-w-[950px] tracking-[-2%] leading-[31.2px] w-11/12  text-[20px] text-[#7A7F8A] ">
        ...
        {/* Auto-Slider Section */}
        <div className="relative w-full max-w-[1228.8px] h-auto max-h-[736.32px] overflow-hidden  rounded-[19.2px] border-[9.6px] border-opacity-[48%] gap-[9.6px]">
          {/* Current Image */}
          <Image
